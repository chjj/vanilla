...
/*
    Object.keys(Application.prototype).forEach(function(key) {
      if (key === 'url') {
        _.https.prototype.__defineGetter__(key,
          Application.prototype.__lookupGetter__(key));
        return;
      }
...
*/
    ...
    Object.getOwnPropertyNames(Application.prototype).forEach(function(key) {
      Object.defineProperty(_.https.prototype, key,
        Object.getOwnPropertyDescriptor(Application.prototype, key));
    });
...
/*
    ...
    Object.defineProperties(_.https.prototype, out);
*/
  }
  return _.https;
});
